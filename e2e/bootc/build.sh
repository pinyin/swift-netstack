...
# Copy pre-compiled static binaries from initramfs (Go aarch64, no libc needed)
mkdir -p "$SCRIPT_DIR/bin"
cp "$SCRIPT_DIR/../initramfs/bin/tcpstress" "$SCRIPT_DIR/bin/tcpstress"
...
echo "  cd $(dirname "$SCRIPT_DIR") && ./run.sh --bootc"
